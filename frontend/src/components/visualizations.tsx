...
const PrefixAllocation = lazy(() => import('./visualizations/prefixAllocation'));
const ASNRelationships = lazy(() => import('./visualizations/asnRelationships'));
const HistoricalTimeline = lazy(() => import('./visualizations/historicalTimeline'));
const RIRDistribution = lazy(() => import('./visualizations/rirDistribution'));
    ...
    <div className="container-fluid">
      <div className="row">
        <div className="col-md-12">
          ...
          <div className="card mb-4">
            ...
            <div className="card-body">
              <p className="text-muted">
                Explore IRR data through interactive visualizations including prefix allocations, ASN relationships,
                historical trends, and geographical RIR distributions.
              </p>
            </div>
          </div>
          ...
          <ErrorBoundary>{renderVisualization()}</ErrorBoundary>
        </div>
      </div>
    </div>
  );
